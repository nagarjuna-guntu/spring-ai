insert into game (title, description, min_players, max_players, min_playing_time, max_playing_time)
values ('Sagrada', 'A dice-drafting game where players create beautiful ' ||
       ...
       ('Flip 7', 'A fast-paced card game where players try to flip cards to ' ||
                  'get the highest score, but avoiding flipping a duplicate card', 3, 13, 15, 30);