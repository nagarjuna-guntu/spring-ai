...
public class AiConfig {
    ...
    // CassandraChatMemoryRepository, Neo4jChatMemoryRepository, JdbcChatMemoryRepository are use persistence storage
    // Any one of the CassandraChatMemoryRepository, Neo4jChatMemoryRepository implementations available on class path,
    // spring autoconfigures with below configuration. For JdbcChatMemoryRepository use HSQLDB, MySQL, PostgreSQL,
    // SQL Server databases, should mention the specific configurations based on the DB type.
